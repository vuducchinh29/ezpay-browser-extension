...
import WalletCreationController from '@ezpay/popup/src/controllers/WalletCreationController';
import CreateAccountController from '@ezpay/popup/src/controllers/CreateAccountController';
import RestoreAccountController from '@ezpay/popup/src/controllers/RestoreAccountController';
import PageController from '@ezpay/popup/src/controllers/PageController';
import ConfirmationController from '@ezpay/popup/src/controllers/ConfirmationController';
import ReceiveController from '@ezpay/popup/src/controllers/ReceiveController';
import SendController from '@ezpay/popup/src/controllers/SendController';
import TransactionsController from '@ezpay/popup/src/controllers/TransactionsController';
import SettingController from '@ezpay/popup/src/controllers/SettingController';
import AddTokenController from '@ezpay/popup/src/controllers/AddTokenController';
import BankController from '@ezpay/popup/src/controllers/TronBankController';
import BankRecordController from '@ezpay/popup/src/controllers/BankRecordController';
import BankDetailController from '@ezpay/popup/src/controllers/BankDetailController';
import BankHelplController from '@ezpay/popup/src/controllers/TronBankHelp';
import IncomeRecordController from '@ezpay/popup/src/controllers/IncomeRecordController';
import ActivityDetailController from '@ezpay/popup/src/controllers/ActivityDetailController';
import DappListController from '@ezpay/popup/src/controllers/DappListController';
import AssetManageController from '@ezpay/popup/src/controllers/AssetManageController';
import TransactionDetailController from '@ezpay/popup/src/controllers/TransactionDetailController';
import DappWhitelistController from '@ezpay/popup/src/controllers/DappWhitelistController';
...
import zhMessages from '@ezpay/popup/src/translations/zh.json';
import jaMessages from '@ezpay/popup/src/translations/ja.json';
