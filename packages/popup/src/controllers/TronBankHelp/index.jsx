                    ...
                    <Accordion className='my-accordion' onChange={this.onChange}>
                        ...
                        <Accordion.Panel header={formatMessage({ id: 'BANK.HELP.CONTACT' })}π className='feedback'>
                            <section className='feedbackCont'>
                                ...
                                <p className='content'>
                                    <img src={require('../../assets/images/new/tronBank/telegram.svg')} alt='telegram'/><a href='https://t.me/Tronlending' rel='noopener noreferrer' target='_blank'><span className='linkStyle'>EZpay Official Group）</span></a>
                                </p>
                                <h2 className='title'>
