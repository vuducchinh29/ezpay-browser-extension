...
import Header from '@ezpay/popup/src/controllers/PageController/Header';
import ProcessBar from '@ezpay/popup/src/components/ProcessBar';
import Button from '@ezpay/popup/src/components/Button';
import { connect } from 'react-redux';
import { CONTRACT_ADDRESS, APP_STATE, BUTTON_TYPE } from '@ezpay/lib/constants';
import { FormattedMessage, injectIntl } from 'react-intl';
import './AccountsPage.scss';
import '@ezpay/popup/src/controllers/PageController/Header/Header.scss';
const trxImg = require('@ezpay/popup/src/assets/images/new/trx.png');
const token10DefaultImg = require('@ezpay/popup/src/assets/images/new/token_10_default.png');
let tronscanUrl = '';
