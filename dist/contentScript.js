...
/*!*********************************************************************************************!*\
  !*** /home/dev/ezpay-browser-extension/node_modules/@babel/runtime/helpers/objectSpread.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
/***/ (function(module, exports, __webpack_require__) {
...
/*! ModuleConcatenation bailout: Cannot concat with /home/dev/ezpay-browser-extension/node_modules/@babel/runtime/helpers/objectSpread.js (<- Module is not an ECMAScript module) */
...
// EXTERNAL MODULE: /home/dev/ezpay-browser-extension/node_modules/@babel/runtime/helpers/objectSpread.js
  ...
  createClass_default()(MessageDuplexHost, [{
    ...
    value: function handleNewConnection(channel) {
      ...
      channel.onMessage.addListener(function (message) {
        return _this2.handleMessage(name, objectSpread_default()({}, message, {
          hostname: hostname
        }));
      });
    ...
    value: function handleMessage(source, message) {
      ...
      this.incoming.set(messageID, function (res) {
        return _this3.send(source, 'messageReply', objectSpread_default()({
          messageID: messageID
        }, res), false);
      });
      this.emit(action, {
...
function (_EventEmitter) {
  ...
  createClass_default()(MessageDuplexChild, [{
    ...
    value: function handleMessage(_ref) {
      ...
      this.incoming.set(messageID, function (res) {
        return _this3.send('messageReply', objectSpread_default()({
          messageID: messageID
        }, res), false);
      });
      this.emit(action, {
...
var contentScript = {
  ...
  init: function init() {
    index_logger.info('Initialising TronLink');
  ...
  inject: function inject() {
    ...
    index_logger.info('TronLink injected');
  }
};
contentScript.init();
